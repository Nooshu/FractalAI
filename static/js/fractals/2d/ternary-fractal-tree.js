...
// Generate vertices for ternary fractal tree
function generateTernaryFractalTree(iterations, branchAngle, lengthRatio) {
  const segments = [];
...
export function render(regl, params, canvas, options = {}) {
  ...
  const vertices = generateTernaryFractalTree(iterationLevel, branchAngle, lengthRatio);
  ...
  return drawTernaryTree;
}

export const is2D = true;

/**
 * Configuration for Ternary Fractal Tree
 */
export const config = {
  initialSettings: {
    colorScheme: 'cosmic'
  ...
  // Interesting bounds for "surprise me" - Ternary fractal tree is always interesting
  interestingBounds: {
    offsetX: [-1, 1],
    offsetY: [-1, 1],
    zoom: [0.5, 10],
