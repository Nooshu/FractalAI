...
export function renderLuma(device, params, canvas) {
  return createLumaDrawCommand(device, 'spider-set', fractalFunction, params, canvas);
}
...
export const config = {
  ...
  // Interesting bounds for "surprise me" - Spider Set has interesting features around negative X
  interestingBounds: {
    offsetX: [-2.5, 1.5],
    offsetY: [-2, 2],
    zoom: [0.5, 100],
