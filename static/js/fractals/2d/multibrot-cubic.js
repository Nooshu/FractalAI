...
// Helper function to create UBO-aware fragment shader for cubic multibrot
function createCubicMultibrotFragmentShader(useUBO) {
...
export function render(regl, params, canvas, options = {}) {
  ...
  const fragmentShader = createCubicMultibrotFragmentShader(useUBO);

  // Use createStandardDrawCommand for UBO support
  // Note: cubic multibrot uses custom shader, so we pass it directly
...
/**
 * Configuration for Cubic Multibrot fractal
 */
export const config = {
  initialSettings: {
