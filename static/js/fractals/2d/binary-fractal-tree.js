...
function generateBinaryFractalTree(iterations, branchAngle, lengthRatio) {
  const segments = [];
...
export function render(regl, params, canvas, options = {}) {
  ...
  const vertices = generateBinaryFractalTree(iterationLevel, branchAngle, lengthRatio);
...
/**
 * Configuration for Binary Fractal Tree
 */
export const config = {
  initialSettings: {
    colorScheme: 'cosmic'
  ...
  // Interesting bounds for "surprise me" - Binary fractal tree is always interesting
  interestingBounds: {
    offsetX: [-1, 1],
    offsetY: [-1, 1],
    zoom: [0.5, 10],
