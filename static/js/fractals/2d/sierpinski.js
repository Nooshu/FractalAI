...
export function render(regl, params, canvas, options = {}) {
  ...
  return createStandardDrawCommand(regl, params, canvas, fragmentShader, {
    webglCapabilities,
    ubo,
    juliaC: { x: 0, y: 0 }, // Not used for Sierpinski
  });
}
...
/**
 * Configuration for Sierpinski fractal
 */
export const config = {
  initialSettings: {
    colorScheme: 'galaxy',
  ...
  // Interesting bounds for "surprise me" - Sierpinski triangle is always interesting, centered
  interestingBounds: {
    offsetX: [-1, 1],
    offsetY: [-1, 1],
    zoom: [0.5, 10],
