...
function createMultibrotJuliaFragmentShader(useUBO) {
...
export function render(regl, params, canvas, options = {}) {
  ...
  const fragmentShader = createMultibrotJuliaFragmentShader(useUBO);
...
export function renderLuma(device, params, canvas) {
  const fragmentShader = createMultibrotJuliaFragmentShader(true);
